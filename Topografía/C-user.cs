...
{
    public partial class C_user : Form
    {
        ...
        private void FolioC(object sender, EventArgs e)
        {
            if (txtFolioC.Text == "")
            {
                epError.SetError(txtFolioC, "Por favor, introduce tu folio.");
                txtFolioC.Focus();
            }
        }
        ...
        private void Register_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    cmd = new SqlCommand("INSERT INTO Cliente (FolioCliente, NombreCompleto, Direccion, Telefono, Correo) VALUES (@FolioCliente, @NombreCompleto, @Direccion, @Telefono, @Correo)", con);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.AddWithValue("@FolioCliente", Folio);
        ...
        private void FolioKey(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                NameC.Focus();
        ...
        private void FBD(object sender, EventArgs e)
        {
            ...
            string query = "SELECT FolioCliente FROM Cliente WHERE (FolioCliente='" + txtFolioC.Text + "')";
            con.Open();
